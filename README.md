...
- Windows [Download ver 1.0.7](https://github.com/MayGo/backer-timetracker/releases/download/1.0.8/Backer.Timetracker.Setup.exe) (Tested win 10)
- OS X [Download ver 1.0.7](https://github.com/MayGo/backer-timetracker/releases/download/1.0.8/Backer.Timetracker.dmg) (Tested El Capitan). Needs permission: Security & Privacy -> Accessibility -> enable backer-timetracker.app (Should ask for this)
