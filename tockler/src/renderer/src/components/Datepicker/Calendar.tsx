...
export const Calendar = ({
    ...
    function goToPrevious() {
        const newDate = dayjs(selectedDate).subtract(1, selectedMode);
        setSelectedDate(newDate);
        dp.onDateSelect(newDate.toDate());
    }

    function goToNext() {
        const newDate = dayjs(selectedDate).add(1, selectedMode);
        setSelectedDate(newDate);
        dp.onDateSelect(newDate.toDate());
    }
    ...
    const onChangeYear = (event) => {
        ...
        const newDate = dayjs(selectedDate).set('year', value);
        setSelectedDate(newDate);
        dp.onDateSelect(newDate.toDate());
    };
    ...
    const onChangeMonth = (event) => {
        const value = event.target.value;
        const newDate = dayjs(selectedDate).set('month', value);
        setSelectedDate(newDate);
        dp.onDateSelect(newDate.toDate());
    };
