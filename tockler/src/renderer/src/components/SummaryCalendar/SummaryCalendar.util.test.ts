...
describe('summariseTimeOnline', () => {
    it('parses online items', () => {
        const actual = summariseTimeOnline(TEST_INPUT, 'month', dayjs(1589311528755));
        const result = {
    ...
    it('online item over midnight - until 04:00 - it goes to previous day', () => {
        const input = [
            {
                app: 'ONLINE',
                beginDate: dayjs('2020-04-10 02:30').valueOf(),
                endDate: dayjs('2020-04-10 03:30').valueOf(),
            },
        ];
        const actual = summariseTimeOnline(input, 'month', dayjs('2020-04-10 04:30'));
        const result = {
            '04-09': {
                beginDate: dayjs('2020-04-10 02:30').valueOf(),
                endDate: dayjs('2020-04-10 03:30').valueOf(),
    ...
    it('online item after 04:00 goes to correct day', () => {
        const input = [
            {
                app: 'ONLINE',
                beginDate: dayjs('2020-04-10 04:30').valueOf(),
                endDate: dayjs('2020-04-10 05:30').valueOf(),
            },
        ];
        const actual = summariseTimeOnline(input, 'month', dayjs('2020-04-10 04:30'));
        const result = {
    ...
    it('woke up 04:30 and went to sleep 03:30', () => {
        const input = [
            ...
            {
                app: 'ONLINE',
                beginDate: dayjs('2020-04-10 11:30').valueOf(),
                endDate: dayjs('2020-04-10 15:30').valueOf(),
            },
            {
                app: 'ONLINE',
                beginDate: dayjs('2020-04-10 23:30').valueOf(),
                endDate: dayjs('2020-04-11 01:30').valueOf(),
            },
            {
                app: 'ONLINE',
                beginDate: dayjs('2020-04-11 02:30').valueOf(),
                endDate: dayjs('2020-04-11 03:30').valueOf(),
            },
        ];
        const actual = summariseTimeOnline(input, 'month', dayjs('2020-04-10 04:30'));
        const result = {
