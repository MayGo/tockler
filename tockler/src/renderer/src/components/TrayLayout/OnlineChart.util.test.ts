...
const beginDate0 = dayjs('2021-06-18T23:50:00').valueOf();
const endDate0 = dayjs('2021-06-19T00:10:00').valueOf();

const beginDate1 = dayjs('2021-06-19T10:00:00').valueOf();
const endDate1 = dayjs('2021-06-19T10:10:00').valueOf();

const beginDate2 = dayjs('2021-06-19T11:50:00').valueOf();
const endDate2 = dayjs('2021-06-19T12:10:00').valueOf();

const beginDate3 = dayjs('2021-06-19T18:50:00').valueOf();
const endDate3 = dayjs('2021-06-19T19:10:00').valueOf();

const beginDate4 = dayjs('2021-06-19T23:50:00').valueOf();
const endDate4 = dayjs('2021-06-20T00:10:00').valueOf();

const realDate = dayjs('2021-06-19T10:10:00').valueOf();
describe('OnlineChart getOnlineTimesForChart', () => {
    it('uses only ONLINE items', () => {
        const beginDate = dayjs('2021-06-19T18:00:00').valueOf();
        const otherItems = [
            {
                app: OFFLINE,
                beginDate: dayjs('2021-06-19T16:00:00').valueOf(),
                endDate: dayjs('2021-06-19T17:10:00').valueOf(),
            },
            {
                beginDate: beginDate,
                endDate: dayjs('2021-06-19T18:10:00').valueOf(),
            },
        ];
    ...
    it('Sets first, last and in between empty items hours 0 to 24', () => {
        ...
        expect(actual).toEqual([
            {
                beginDate: dayjs('2021-06-19T00:00:00').valueOf(),
                endDate: beginDate1,
                color: 'transparent',
                diff: 600,
                x: 0,
            ...
            {
                beginDate: endDate3,
                endDate: dayjs('2021-06-19T24:00:00').valueOf(),
                color: 'transparent',
                diff: 290,
                x: 4,
            },
    ...
    it('Sets first, last and in between empty items for hours 12 to 24', () => {
        ...
        expect(actual).toEqual([
            {
                beginDate: dayjs('2021-06-19T12:00:00').valueOf(),
                endDate: beginDate3,
                color: 'transparent',
                diff: 410,
                x: 0,
    ...
    it('Clamps items for hours 12 to 24 endDate', () => {
        ...
        expect(actual).toEqual([
            ...
            },
            {
                app: ONLINE,
                beginDate: beginDate2,
                endDate: dayjs('2021-06-19T12:00:00').valueOf(),
                diff: 10,
                x: 1,
            },
        ]);
...
const getDateFromTime = (time: string) => {
    return dayjs(`2021-06-19T${time}`).valueOf();
};
